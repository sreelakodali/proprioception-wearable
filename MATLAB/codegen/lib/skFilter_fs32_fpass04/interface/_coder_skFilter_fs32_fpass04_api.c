 ...
 * File: _coder_skFilter_fs32_fpass04_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "skFilter_fs32_fpass04",                              /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void skFilter_fs32_fpass04_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  skFilter_fs32_fpass04(*x_data, *(int32_T(*)[1]) & x_size, *y_data, y_size);
...
void skFilter_fs32_fpass04_atexit(void)
{
  ...
  skFilter_fs32_fpass04_xil_terminate();
  skFilter_fs32_fpass04_xil_shutdown();
...
/*
 * File trailer for _coder_skFilter_fs32_fpass04_api.c
 *
 * [EOF]
 */
