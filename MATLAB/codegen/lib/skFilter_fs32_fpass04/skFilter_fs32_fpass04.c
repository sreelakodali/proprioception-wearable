 ...
 * Return Type  : void
 */
void skFilter_fs32_fpass04(const short x_data[], const int x_size[1],
                           float y_data[], int y_size[2])
{
  dsp_BiquadFilter_0 *obj;
  int i;
  int ioIdx;
  if (!isInitialized_skFilter_fs32_fpass04) {
...
/*
 * File trailer for skFilter_fs32_fpass04.c
 *
 * [EOF]
 */
