 ...
 * Return Type  : void
 */
void main_skFilter3(void)
{
  emxArray_real_T *y;
  int x_size;
  short x_data[10000];
  /* Initialize function 'skFilter3' input arguments. */
  /* Initialize function input argument 'x'. */
  argInit_d10000x1_int16_T(x_data, &x_size);
  /* Call the entry-point 'skFilter3'. */
  emxInitArray_real_T(&y, 2);
  skFilter3(x_data, &x_size, y);
