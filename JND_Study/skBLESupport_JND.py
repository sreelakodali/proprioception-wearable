...
EXPERIMENT_TEXT_1 = ["Experiment", "Task: Identify whether Stimulus A feels more", "intense or less intense than Stimulus B.", "", "",  "", "", "", "", "", "Use > and < keys to indicate your answer,", "and then click the red key to go to the next trial.", "Please click the red key to proceed."]
EXPERIMENT_TEXT_5 = ["Task: Identify whether Stimulus A feels more", "intense or less intense than Stimulus B.", "", "",  "", "", "", "", "", "Use > and < keys to indicate your answer,", "and then click the red key to go to the next trial.", "Please click the red key to proceed."]
...
CALIBRATION_TEXT1 = ["Measurement: Keypad Controls", "Please indicate your minimum detection and", "maximum comfortable pressures. Controls are:", "", "8 retracts the", "device fully", "", "> and < increase", "decrease", "pressure", "", "Please use = to indicate when you feel a min/max", "pressure. Click the red key for more details."]
...
CALIBRATION_TEXT3 = ["Measurement: Minimum", "1. Apply pressure with >", "2. When you first feel contact, click =.", "3. Click 8 to retract the device.",  "4. Repeat steps 1-3 for a total of 3 times.", "", "", "", "", "", "", "Once done, click the red key to move on."]
CALIBRATION_TEXT4 = ["Measurement: Maximum", "1. Apply pressure with >. Use > and <", "to hone into your maximum comfortable pressure.", "2. Click = when you've reached your maximum",  "comfortable pressure.", "3. Click 8 to retract the device.", "4. Repeat steps 1-3 for a total of 3 times.", "", "", "", "", "Once done, click the red key to move on."]
