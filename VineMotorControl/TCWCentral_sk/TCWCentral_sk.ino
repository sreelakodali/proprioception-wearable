...
// Modified by Sreela Kodali, kodali@stanford.edu
// June 5th 2024
...
//const String localNames[numWinches] = {"TCW_1", "TCW_2", "TCW_3", "TCW_4"};
const String tcwPrefix = "TCW_";

// define LED pins
const int onLedPin = LEDG;    // LED indicator: setup is complete (ble is advertising)
const int bleLedPin = LEDB;   // LED indicator: nano is connected to a peripheral
const int failLedPin = LEDR;  // LED indicator: ble has failed
...
//   Serial.begin(9600);
  ...
  digitalWrite(onLedPin, HIGH); // off
  digitalWrite(bleLedPin, HIGH); // off
  digitalWrite(failLedPin, HIGH); // off
