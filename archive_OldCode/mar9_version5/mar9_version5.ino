/*
 * Full System, Version 5.0
 * Written: March 9th, 2022 by Sreela Kodali (kodali@stanford)
 * 
 * */
...
char packet[100];
char floatBuffer1[15];
char floatBuffer2[15];
...
//      sprintf(packet, "%d, Flex sensor: %d, Actuator Pos Command: %d, Actuator Pos Measured: %s, Force: %s\n", 
//        myTime, flexSensor, position1_Command, dtostrf(position1_Measured, 6, 3, floatBuffer1), dtostrf(force, 6, 3, floatBuffer2));
