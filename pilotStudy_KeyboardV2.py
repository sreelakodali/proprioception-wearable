...
trialAngles = nTargetAngles + nHaptics + nPractice + nTest
...
while (datetime.datetime.now() < endTime):
	...
	for i in value:
		...
		skP.writeOutData(i,dataFunc, writer2, writer, nTrials, nTrials, bookmark)
...
while (nTrials < len(nTargetAngles)):
	...
	value = mcu.readlines()
	for i in value:
		skP.writeOutData(i,dataFunc, writer2, writer, nTrials, nTargetAngles[nTrials], bookmark)
...
while (nTrials < len(nHaptics)):
	...
	value = mcu.readlines()
	for i in value:
		skP.writeOutData(i,dataFunc, writer2, writer, nTrials, nHaptics[nTrials], bookmark)
...
while (nTrials < len(nPractice)):
	...
	value = mcu.readlines()
	for i in value:
		skP.writeOutData(i,dataFunc, writer2, writer, nTrials, nPractice[nTrials], bookmark)
...
while (nTrials < len(nTest)):
	...
	value = mcu.readlines()
	for i in value:
		skP.writeOutData(i,dataFunc, writer2, writer, nTrials, nTest[nTrials], bookmark)
