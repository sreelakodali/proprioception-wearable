...
#data <- read.csv("C:\\Users\\brian\\Downloads\\sreelaData_without28.csv")
...
#"C:\Users\brian\Downloads\sreelaData_without28.csv"
...
res.aov <- anova_test(
  data = data, dv = ABSError, wid = Subject,
  within = c(Haptic, Visual), effect.size = "pes", repeated = TRUE
)
get_anova_table(res.aov, correction = 'GG')
